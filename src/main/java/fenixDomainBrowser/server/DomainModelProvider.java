...
public class DomainModelProvider {
    ...
    public static class DomainModelDefinitions {
        ...
        public DomainModelDefinitions(List<String> data) {
            ...
            for (String content : data) {
                ...
                contents[i] = new String(Base64.encodeBase64(zipFile));
                signatures[i] = new String(Base64.encodeBase64(md.digest(zipFile)));
                i++;
            }
    ...
    private HashMap<DomainModelSignatures, LoadedDomainModel> domainModels =
            new HashMap<DomainModelSignatures, DomainModelProvider.LoadedDomainModel>();
    ...
    public void loadFromDomainModelDomainModelDefinitions(DomainModelDefinitions dmd) {
        ...
        for (String filename : dmd.fileNames) {
            ...
            try {
                ...
                byte[] b = Base64.decodeBase64(dmd.contents[i].getBytes());
